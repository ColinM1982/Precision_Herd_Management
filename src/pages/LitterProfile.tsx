...
export default function LitterProfile({farm}:{farm:Farm}) {
  ...
  async function archiveLitter(){
    ...
    if(!window.confirm(`Archive ${current.group_name}? It will move from active Litters to Outside the Herd. Its records and exports will remain available.`))return
