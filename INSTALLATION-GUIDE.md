...
2. Copy and run each verification file in order: `01_VERIFY_PACKAGE_1.sql`, `02_VERIFY_PACKAGE_2.sql`, `03_VERIFY_ANIMAL_CENTERED_REPRODUCTION.sql`, `04_VERIFY_OUTSIDE_HERD_ARCHIVE.sql`, and `05_VERIFY_REPRODUCTIVE_STATUS_SUMMARY.sql`.
3. Confirm:
